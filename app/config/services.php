 ...
 */
$di->set('mongo_test',function () {
    $config = $this->getConfig();
    $mongo = new MongoClient("mongodb://". $config->mongodb_test->host. ":". $config->mongodb_test->port);
...
/**
 * Setting up the collection Manager when set the mongo
 */
